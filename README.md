...
### Analysis performed
Currently, SpicePyBot has been used by 2411 users for a total of 34749 analysis. Fig. 1 shows the percentages of the different analysis (`.op` = operating point, `.tran` = transient, `.ac` = alternating current).
