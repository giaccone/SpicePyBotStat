...
### Analysis performed
Currently, SpicePyBot has been used by 1182 users for a total of 15306 analysis. Fig. 1 shows the percentages of the different analysis (`.op` = operating point, `.tran` = transient, `.ac` = alternatig current).
